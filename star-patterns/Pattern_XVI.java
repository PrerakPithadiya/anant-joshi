...
public class Pattern_XVI {
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 2 * numRows - 1; i++) {
            ...
            if (i < numRows) {
                numStars--; // Decrease number of stars for upper half of the pattern
            } else {
                numStars++; // Increase number of stars for lower half of the pattern
            }
